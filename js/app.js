...
let Ghazi=new Emp(generateEmployeeId,"Ghazi Samer","Adminstration","senior","",calculateSalary("Senior"));
let Lana=new Emp(generateEmployeeId,"Lana Ali","Finance","Senior","",calculateSalary("Senior"));
let Tamara=new Emp(generateEmployeeId,"Tamara Ayoub","Marketing","senior","",calculateSalary("Senior"));
let Safi =new Emp(generateEmployeeId,"Safi Waleed","Administration","Mid-Senior","",calculateSalary("Midsenior"));
 let omar=new Emp(generateEmployeeId,"Omar Zaid","Development","Senior","",calculateSalary("Senior"));           
 let Rana=new Emp(generateEmployeeId,"Rana Saleh","Development","Junior","",calculateSalary("Junior"));
 let Hadi=new Emp(generateEmployeeId,"Hadi Ahmad","Finance","Mid-Senior","",calculateSalary("Midsenior"));
